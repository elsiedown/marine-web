...
function Coaching() {
  return (
    <>
      {/* <h1>Coaching</h1> */}
      <h1>Approach</h1>
      <p>I work with women who find it difficult to feel heard, have low self-esteem, and/or are experiencing a lack of drive or a feeling purpose in their lives. I know that life can feel like a scary, intense and demanding place especially during what are meant to be the ‘best years’.</p>
      ...
      <h1>What's Next?</h1>
      <p><strong>Step 1</strong> - Fill out this form (2-3 minutes)</p>
      <p>The form will ask questions about your current situation, your goals, what you would like to get out of life coaching and possible barriers in your way.</p>
      <p>Step 2 - Free introductory call (30 minutes)</p>
      ...
      <p>Step 3 - Confirm next steps and an initial plan</p>
